...
To demonstrate usage, we consider the `mediation_example` data included with `mediator`. This data set contains exposure/treatment variable `x`  (binary), mediator variable `m` (continuous), outcome variable `y` (binary), and confounder `c` (continuous).
